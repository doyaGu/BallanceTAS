...
void LuaApi::RegisterCK3dEntity(sol::state &lua) {
    ...
    auto ck3dEntityType = lua.new_usertype<CK3dEntity>(
        ...
        "set_parent", sol::overload(
            [](CK3dEntity &entity, CK3dEntity *parent) { return entity.SetParent(parent); },
            [](CK3dEntity &entity, CK3dEntity *parent, CKBOOL keepWorldPos) {
                return entity.SetParent(parent, keepWorldPos);
            }
        ),
        "get_parent", &CK3dEntity::GetParent,
        "add_child", sol::overload(
            [](CK3dEntity &entity, CK3dEntity *child) { return entity.AddChild(child); },
            [](CK3dEntity &entity, CK3dEntity *child, CKBOOL keepWorldPos) {
                return entity.AddChild(child, keepWorldPos);
            }
        ),
        // "add_children", sol::overload(
        //     [](CK3dEntity &entity, const XObjectPointerArray &children) { return entity.AddChildren(children); },
        //     [](CK3dEntity &entity, const XObjectPointerArray &children, CKBOOL keepWorldPos) {
        ...
        "check_if_same_kind_of_hierarchy", sol::overload(
            [](CK3dEntity &entity, CK3dEntity *mov) { return entity.CheckIfSameKindOfHierarchy(mov); },
            [](CK3dEntity &entity, CK3dEntity *mov, CKBOOL sameOrder) {
        ...
        "set_pickable", sol::overload(
            ...
            [](CK3dEntity &entity, CKBOOL pick) { entity.SetPickable(pick); }
        ),
        "is_pickable", &CK3dEntity::IsPickable,
        "set_render_channels", sol::overload(
            [](CK3dEntity &entity) { entity.SetRenderChannels(); },
            [](CK3dEntity &entity, CKBOOL renderChannels) { entity.SetRenderChannels(renderChannels); }
        ),
        "are_render_channels_visible", &CK3dEntity::AreRenderChannelsVisible,

        // View frustum tests
        "is_in_view_frustum", sol::overload(
            [](CK3dEntity &entity, CKRenderContext *dev) { return entity.IsInViewFrustrum(dev); },
            [](CK3dEntity &entity, CKRenderContext *dev, CKDWORD flags) {
                return entity.IsInViewFrustrum(dev, flags);
            }
        ),
        "is_in_view_frustum_hierarchic", &CK3dEntity::IsInViewFrustrumHierarchic,
        "is_all_inside_frustum", &CK3dEntity::IsAllInsideFrustrum,
        ...
        "set_render_as_transparent", sol::overload(
            ...
            [](CK3dEntity &entity, CKBOOL trans) { entity.SetRenderAsTransparent(trans); }
        ),
        ...
        "look_at", sol::overload(
            ...
            [](CK3dEntity &entity, const VxVector *pos, CK3dEntity *ref, CKBOOL keepChildren) {
        ...
        "rotate", sol::overload(
            ...
            [](CK3dEntity &entity, const VxVector *axis, float angle, CK3dEntity *ref, CKBOOL keepChildren) {
            ...
            [](CK3dEntity &entity, float x, float y, float z, float angle, CK3dEntity *ref, CKBOOL keepChildren) {
        ...
        "translate", sol::overload(
            ...
            [](CK3dEntity &entity, const VxVector *vect, CK3dEntity *ref, CKBOOL keepChildren) {
            ...
            [](CK3dEntity &entity, float x, float y, float z, CK3dEntity *ref, CKBOOL keepChildren) {
        ...
        "set_quaternion", sol::overload(
            ...
            [](CK3dEntity &entity, const VxQuaternion *quat, CK3dEntity *ref, CKBOOL keepChildren) {
                entity.SetQuaternion(quat, ref, keepChildren);
            },
            [](CK3dEntity &entity, const VxQuaternion *quat, CK3dEntity *ref, CKBOOL keepChildren, CKBOOL keepScale) {
        ...
        "set_scale", sol::overload(
            ...
            [](CK3dEntity &entity, const VxVector *scale, CKBOOL keepChildren) {
            ...
            [](CK3dEntity &entity, float x, float y, float z, CKBOOL keepChildren, CKBOOL local) {
        ...
        "get_scale", sol::overload(
            ...
            [](CK3dEntity &entity, VxVector *scale, CKBOOL local) { entity.GetScale(scale, local); }
        ),

        // Matrix operations
        "construct_world_matrix", &CK3dEntity::ConstructWorldMatrix,
        "construct_world_matrix_ex", &CK3dEntity::ConstructWorldMatrixEx,
        "construct_local_matrix", &CK3dEntity::ConstructLocalMatrix,
        "construct_local_matrix_ex", &CK3dEntity::ConstructLocalMatrixEx,

        "set_local_matrix", sol::overload(
            [](CK3dEntity &entity, const VxMatrix &mat) { entity.SetLocalMatrix(mat); },
            [](CK3dEntity &entity, const VxMatrix &mat, CKBOOL keepChildren) {
        ...
        "update_box", sol::overload(
            ...
            [](CK3dEntity &entity, CKBOOL world) { entity.UpdateBox(world); }
        ),
        "get_bounding_box", sol::overload(
            [](CK3dEntity &entity) { return entity.GetBoundingBox(); },
            [](CK3dEntity &entity, CKBOOL local) { return entity.GetBoundingBox(local); }
        ),
        "set_bounding_box", sol::overload(
            [](CK3dEntity &entity, const VxBbox *bbox) { return entity.SetBoundingBox(bbox); },
            [](CK3dEntity &entity, const VxBbox *bbox, CKBOOL local) { return entity.SetBoundingBox(bbox, local); }
        ),
        "get_hierarchical_box", sol::overload(
            [](CK3dEntity &entity) { return entity.GetHierarchicalBox(); },
            [](CK3dEntity &entity, CKBOOL local) { return entity.GetHierarchicalBox(local); }
        ),
