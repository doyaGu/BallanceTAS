...
static PhysicsObject *CheckPhysicsObject(lua_State *L, int index) {
...
static void PushVxMatrix(lua_State *L, const VxMatrix &value) {
...
static int InvMass(lua_State *L) {
    auto *object = CheckPhysicsObject(L, 1);
...
static int GetInvInertia(lua_State *L) {
    VxVector inertia;
...
static int GetDampingSpeed(lua_State *L) {
    float speed = 0.0f;
...
static int GetDampingRotation(lua_State *L) {
    float rotation = 0.0f;
...
static int GetPositionMatrix(lua_State *L) {
    VxMatrix matrix;
...
static int FrictionCount(lua_State *L) {
    auto *object = CheckPhysicsObject(L, 1);
